...
plot(xp,yp,"-k;Interpolacao sobre m=16+1 'nos' equidistantes n=16;",'LineWidth',1,xk,yk,'ok','markersize',10,xp,ypk,"-k;Interpolacao sobre m=16+1 'nos' de Chebyshev n=16;",'LineWidth',2,xpp,ypp,"--k;n=16 Splines Cubicas;",'LineWidth',1)
%,xp,ye,".r;Funcao exata f(x)=1/(1+25*x*x);"
