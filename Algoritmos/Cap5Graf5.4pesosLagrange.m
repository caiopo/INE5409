...
x0=[ 1 3	6	8 ]
plot(x0,0,'bk','markersize',20,x(3),1,'bk','markersize',20,xp,ya(3,:),"-k;funcao peso em x(3)=4;",'LineWidth',2,[1 8],[0 0],'k',[1 8],[1 1],'k')% Plotagem dos pontos originais (*) e ajustadores
grid on